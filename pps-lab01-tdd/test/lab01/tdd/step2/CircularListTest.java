...
class CircularListTest {
    ...
    void testForwardIterator() {
        this.populateList();
        testIteratorYieldings(List.of(1, 2, 3, 1), this.circularList::forwardIterator);
    }

    @Test
    void testBackwardIterator() {
        this.populateList();
        testIteratorYieldings(List.of(3, 2, 1, 3), this.circularList::backwardIterator);
    }
    ...
    void testForwardIteratorOnSingleElement() {
        ...
        testIteratorYieldings(Collections.nCopies(100, 2), this.circularList::forwardIterator);
    }

    @Test
    void testBackwardIteratorOnSingleElement() {
        this.circularList.add(2);
        testIteratorYieldings(Collections.nCopies(100, 2), this.circularList::backwardIterator);
    }
    ...
    void testNewForwardIteratorAfterAdd() {
        ...
        testIteratorYieldings(List.of(1, 2, 3, 4, 1), this.circularList::forwardIterator);
    }
    ...
    void testNewBackwardIteratorAfterAdd() {
        ...
        testIteratorYieldings(List.of(3, 2, 1, 3), this.circularList::backwardIterator);
        this.circularList.add(4);
        testIteratorYieldings(List.of(4, 3, 2, 1, 4), this.circularList::backwardIterator);
    }

    private void testIteratorYieldings(List<Integer> expectedYields, Supplier<Iterator<Integer>> iteratorSupplier) {
